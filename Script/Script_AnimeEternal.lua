            ...
            if Value then
                task.spawn(function()
                    local achievements = {
                        ...
                        Maze_Level_1 = 5,
                        Total_Maze_Level_1 = 5,
                        Maze_Level_2 = 5,
                        Total_Maze_Level_2 = 5,
                        One_Hero_Raid = 19,
                        Dungeon_Labyrinth = 5,
                        Total_Dungeon_Labyrinth = 5,
                        Crimson_Canyon = 8,
                        Mugen_Dungeon = 8,
                        Breathing_Raid = 9,
                    }
...
RewardsGroupbox:AddToggle("AutoChristmasChestToggle", {
    Text = "Auto Christmas Chest",
    Default = isAutoChristmasChestEnabled,
    Tooltip = "Automatically claims Christmas chest.",
    Callback = function(Value)
        isAutoChristmasChestEnabled = Value
        -- SaveManager automatically saves this toggle's value
        if Value then
            task.spawn(function()
                while isAutoChristmasChestEnabled and getgenv().SeisenHubRunning do
                    local args = {
                        [1] = {
                            ["Action"] = "_Chest_Claim",
...
RewardsGroupbox:AddToggle("AutoSantaChestToggle", {
    Text = "Auto Santa Chest",
    Default = isAutoSantaChestEnabled,
    Tooltip = "Automatically claims Santa chest.",
    Callback = function(Value)
        isAutoSantaChestEnabled = Value
        -- SaveManager automatically saves this toggle's value
        if Value then
            task.spawn(function()
                while isAutoSantaChestEnabled and getgenv().SeisenHubRunning do
                    local args = {
                        [1] = {
                            ["Action"] = "_Chest_Claim",
                            ["Name"] = "Santa_Chest"
...
RewardsGroupbox:AddToggle("AutoIceChestToggle", {
    Text = "Auto Ice Chest",
    Default = isAutoIceChestEnabled,
    Tooltip = "Automatically claims Ice chest.",
    Callback = function(Value)
        isAutoIceChestEnabled = Value
        -- SaveManager automatically saves this toggle's value
        if Value then
            task.spawn(function()
                while isAutoIceChestEnabled and getgenv().SeisenHubRunning do
                    local args = {
                        [1] = {
                            ["Action"] = "_Chest_Claim",
                            ["Name"] = "Ice_Chest"
...
RewardsGroupbox:AddToggle("AutoChristmasTreeChestToggle", {
    Text = "Auto Christmas Tree Chest",
    Default = isAutoChristmasTreeChestEnabled,
    Tooltip = "Automatically claims Christmas Tree chest.",
    Callback = function(Value)
        isAutoChristmasTreeChestEnabled = Value
        -- SaveManager automatically saves this toggle's value
        if Value then
            task.spawn(function()
                while isAutoChristmasTreeChestEnabled and getgenv().SeisenHubRunning do
                    local args = {
                        [1] = {
                            ["Action"] = "_Chest_Claim",
...
-- Auto enter Restaurant Raid toggle
RaidDefense:AddToggle(
    "AutoEnterDungeonLabyrinthToggle",
    {
        Text = "Auto Enter Maze Level 1",
        Default = config.AutoEnterDungeonLabyrinthToggle or false,
        Tooltip = "Automatically enters Maze Level 1 Raid when not in dungeon.",
        Callback = function(Value)
            autoEnterDungeonLabyrinthEnabled = Value
            -- SaveManager automatically saves this toggle's value
            if Value then
                if autoEnterDungeonLabyrinthEnabled then autoEnterDungeonLabyrinthEnabled:Disconnect() end
                autoEnterDungeonLabyrinthEnabled = game:GetService("RunService").Heartbeat:Connect(function()
                    local player = game:GetService("Players").LocalPlayer
                    local playerGui = player:FindFirstChild("PlayerGui")
                    local dungeonGui = playerGui and playerGui:FindFirstChild("Dungeon")
                    local header = dungeonGui and dungeonGui:FindFirstChild("Default_Header")
                    ...
                    -- Check if Dungeon Torment header is NOT visible or doesn't contain "Dungeon Torment"
                    if not (header and header.Visible and title and string.find(title.Text or "", "Dungeon Labyrinth")) then
                        local args = {
                            [1] = {
                                ["Action"] = "_Enter_Dungeon",
                                ["Name"] = "Dungeon _Labyrinth"
                            }
                        }
                        local ReplicatedStorage = game:GetService("ReplicatedStorage")
                        local ToServer = ReplicatedStorage:WaitForChild("Events", 9e9):WaitForChild("To_Server", 9e9)
                ...
                if autoEnterDungeonLabyrinthEnabled then
                    autoEnterDungeonLabyrinthEnabled:Disconnect()
                    autoEnterDungeonLabyrinthEnabled = nil
                end
            end
        end
    }
...
-- Auto enter Restaurant Raid toggle
RaidDefense:AddToggle(
    "AutoEnterMazeLevel2Toggle",
    {
        Text = "Auto Enter Maze Level 2",
        Default = config.AutoEnterMazeLevel2Toggle or false,
        Tooltip = "Automatically enters Maze Level 2 Raid when not in dungeon.",
        Callback = function(Value)
            autoEnterMazeLevel2Enabled = Value
            -- SaveManager automatically saves this toggle's value
            if Value then
                if autoEnterMazeLevel2Connection then autoEnterMazeLevel2Connection:Disconnect() end
                autoEnterMazeLevel2Connection = game:GetService("RunService").Heartbeat:Connect(function()
                    local player = game:GetService("Players").LocalPlayer
                    local playerGui = player:FindFirstChild("PlayerGui")
                    local dungeonGui = playerGui and playerGui:FindFirstChild("Dungeon")
                    local header = dungeonGui and dungeonGui:FindFirstChild("Default_Header")
                    ...
                    -- Check if Dungeon Torment header is NOT visible or doesn't contain "Dungeon Torment"
                    if not (header and header.Visible and title and string.find(title.Text or "", "Maze Level 2")) then
                        local args = {
                            [1] = {
                                ["Action"] = "_Enter_Dungeon",
                                ["Name"] = "Maze_Level_2"
                ...
                if autoEnterMazeLevel2Connection then
                    autoEnterMazeLevel2Connection:Disconnect()
                    autoEnterMazeLevel2Connection = nil
                end
            end
        end
    }
...
-- Auto enter Restaurant Raid toggle
RaidDefense:AddToggle(
    "AutoEnterOneHeroRaidToggle",
    {
        Text = "Auto Enter One Hero Raid",
        Default = config.AutoEnterOneHeroRaidToggle or false,
        Tooltip = "Automatically enters One Hero Raid when not in dungeon.",
        Callback = function(Value)
            autoEnterOneHeroRaidEnabled = Value
            -- SaveManager automatically saves this toggle's value
            if Value then
                if autoEnterOneHeroRaidConnection then autoEnterOneHeroRaidConnection:Disconnect() end
                autoEnterOneHeroRaidConnection = game:GetService("RunService").Heartbeat:Connect(function()
                    local player = game:GetService("Players").LocalPlayer
                    local playerGui = player:FindFirstChild("PlayerGui")
                    local dungeonGui = playerGui and playerGui:FindFirstChild("Dungeon")
                    local header = dungeonGui and dungeonGui:FindFirstChild("Default_Header")
                    ...
                    -- Check if Dungeon Torment header is NOT visible or doesn't contain "Dungeon Torment"
                    if not (header and header.Visible and title and string.find(title.Text or "", "One Hero Raid")) then
                        local args = {
                            [1] = {
                                ["Action"] = "_Enter_Dungeon",
                                ["Name"] = "One_Hero_Raid"
                ...
                if autoEnterOneHeroRaidConnection then
                    autoEnterOneHeroRaidConnection:Disconnect()
                    autoEnterOneHeroRaidConnection = nil
                end
            end
        end
    }
...
RaidDefense:AddToggle(
    "AutoEnterDungeonLabyrinthToggle",
    {
        Text = "Auto Enter Dungeon Labyrinth",
        Default = config.AutoEnterDungeonLabyrinthToggle or false,
        Tooltip = "Automatically enters Restaurant Raid when not in dungeon.",
        Callback = function(Value)
            autoEnterRestaurantRaidEnabled = Value
...
-- Auto enter Restaurant Raid toggle
RaidDefense:AddToggle(
    "AutoEnterMugenDungeonToggle",
    {
        Text = "Auto Enter Mugen (Mini) Dungeon",
        Default = config.AutoEnterMugenDungeonToggle or false,
        Tooltip = "Automatically enters Mugen Dungeon when not in dungeon.",
        Callback = function(Value)
            autoEnterMugenDungeonEnabled = Value
            -- SaveManager automatically saves this toggle's value
            if Value then
                if autoEnterMugenDungeonConnection then autoEnterMugenDungeonConnection:Disconnect() end
                autoEnterMugenDungeonConnection = game:GetService("RunService").Heartbeat:Connect(function()
                    local player = game:GetService("Players").LocalPlayer
                    local playerGui = player:FindFirstChild("PlayerGui")
                    local dungeonGui = playerGui and playerGui:FindFirstChild("Dungeon")
                    local header = dungeonGui and dungeonGui:FindFirstChild("Default_Header")
                    ...
                    -- Check if Mugen Dungeon header is NOT visible or doesn't contain "Mugen Dungeon"
                    if not (header and header.Visible and title and string.find(title.Text or "", "Mugen Dungeon")) then
                        local args = {
                            [1] = {
                                ["Action"] = "_Enter_Dungeon",
                                ["Name"] = "Mugen_Dungeon"
                ...
                if autoEnterMugenDungeonConnection then
                    autoEnterMugenDungeonConnection:Disconnect()
                    autoEnterMugenDungeonConnection = nil
                end
            end
        end
    }
...
-- Auto enter Restaurant Raid toggle
RaidDefense:AddToggle(
    "AutoEnterBreathingRaidToggle",
    {
        Text = "Auto Enter Breathing Raid",
        Default = config.AutoEnterBreathingRaidToggle or false,
        Tooltip = "Automatically enters Breathing Raid when not in dungeon.",
        Callback = function(Value)
            autoEnterBreathingRaidEnabled = Value
            -- SaveManager automatically saves this toggle's value
            if Value then
                if autoEnterBreathingRaidConnection then autoEnterBreathingRaidConnection:Disconnect() end
                autoEnterBreathingRaidConnection = game:GetService("RunService").Heartbeat:Connect(function()
                    local player = game:GetService("Players").LocalPlayer
                    local playerGui = player:FindFirstChild("PlayerGui")
                    local dungeonGui = playerGui and playerGui:FindFirstChild("Dungeon")
                    local header = dungeonGui and dungeonGui:FindFirstChild("Default_Header")
                    ...
                    -- Check if Breathing Raid header is NOT visible or doesn't contain "Breathing Raid"
                    if not (header and header.Visible and title and string.find(title.Text or "", "Breathing Raid")) then
                        local args = {
                            [1] = {
                                ["Action"] = "_Enter_Dungeon",
                                ["Name"] = "Breathing_Raid"
                ...
                if autoEnterBreathingRaidConnection then
                    autoEnterBreathingRaidConnection:Disconnect()
                    autoEnterBreathingRaidConnection = nil
                end
            end
        end
    }
...
local teleportLocations = {
    ...
    ["Science Village"] = "Science_Village",
    ["Sand Village"] = "Sand_Village",
    ["Night Raid Base"] = "Night_Raid_Base",
    ["Salty Sachool"] = "Salty_Sachool",
    ["Mugen District"] = "Mugen_District",
}
...
-- Auto Obelisk Damage Upgrade Toggle
Upgrade2:AddToggle(
    "AutoObeliskCoinUpgradeToggle",
    {
        Text = "Obelisk Coin Upgrade",
        Default = config.AutoObeliskCoinUpgradeToggle or false,
        Tooltip = "Automatically upgrades Coin Obelisk.",
        Callback = function(Value)
            autoObeliskCoinUpgradeEnabled = Value
            if Value then
                task.spawn(function()
                    while autoObeliskCoinUpgradeEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Upgrade_Name"] = "Coin",
                                ["Action"] = "_Progression",
...
AutoDeleteGroupbox:AddToggle(
    "AutoDeleteUnitsToggle",
    {
        ...
        do
            ...
            ["Star_29"] = "Science Village",
            ["Star_30"] = "Sand Village",
            ["Star_31"] = "Night Raid Base",
            ["Star_32"] = "Salty School",
            ["Star_33"] = "Mugen District"
        }
        local placeToStar = {}
        local starPlaces = {}
...
RollGroupbox2:AddToggle(
    ...
    {
        Text = "IQ",
        Default = config.AutoRollIQToggle or false,
        Tooltip = "Automatically unlocks and rolls IQ.",
        Callback = function(Value)
            autoRollIQEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                    ...
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    while autoRollIQEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
...
RollGroupbox2:AddToggle(
    "AutoRollScientificWeaponsToggle",
    {
        Text = "Scientific Weapons",
        Default = config.AutoRollScientificWeaponsToggle or false,
        Tooltip = "Automatically unlocks and rolls Scientific Weapons.",
        Callback = function(Value)
            autoRollScientificWeaponsEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                            ["Upgrading_Name"] = "Unlock";
                            ["Action"] = "_Upgrades";
                            ["Name"] = "Scientific_Weapons_Unlock"
                        }
                    }
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    while autoRollScientificWeaponsEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
                                ["Name"] = "Scientific_Weapons"
                            }
                        }
                        pcall(function() ToServer:FireServer(unpack(args)) end)
                        task.wait(0.5)
...
RollGroupbox2:AddToggle(
    "AutoRollPowerofStarsToggle",
    {
        Text = "Power of Stars",
        Default = config.AutoRollPowerofStarsToggle or false,
        Tooltip = "Automatically unlocks and rolls Power of Stars.",
        Callback = function(Value)
            autoRollPowerofStarsEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                            ["Upgrading_Name"] = "Unlock";
                            ["Action"] = "_Upgrades";
                            ["Name"] = "Power_of_Stars_Unlock"
                        }
                    }
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    while autoRollPowerofStarsEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
...
RollGroupbox2:AddToggle(
    "AutoRollShinobiClanToggle",
    {
        Text = "Shinobi Clan",
        Default = config.AutoRollShinobiClanToggle or false,
        Tooltip = "Automatically unlocks and rolls Shinobi Clan.",
        Callback = function(Value)
            autoRollShinobiClanEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                            ["Upgrading_Name"] = "Unlock";
                            ["Action"] = "_Upgrades";
                            ["Name"] = "Shinobi_Clan_Unlock"
                        }
                    }
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    while autoRollShinobiClanEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
...
RollGroupbox2:AddToggle(
    "AutoRollKekkeiGenkaiToggle",
    {
        Text = "Kekkei Genkai",
        Default = config.AutoRollKekkeiGenkaiToggle or false,
        Tooltip = "Automatically unlocks and rolls Kekkei Genkai.",
        Callback = function(Value)
            autoRollKekkeiGenkaiEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                            ["Upgrading_Name"] = "Unlock";
                            ["Action"] = "_Upgrades";
                            ["Name"] = "Kekkei_Genkai_Unlock"
                        }
                    }
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    while autoRollKekkeiGenkaiEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
...
RollGroupbox2:AddToggle(
    "AutoRollPowerEyes2Toggle",
    {
        Text = "Power Eyes 2",
        Default = config.AutoRollPowerEyes2Toggle or false,
        Tooltip = "Automatically unlocks and rolls Power Eyes 2.",
        Callback = function(Value)
            autoRollPowerEyes2Enabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                            ["Upgrading_Name"] = "Unlock";
                            ["Action"] = "_Upgrades";
                            ["Name"] = "Power_Eyes_2_Unlock"
                        }
                    }
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    while autoRollPowerEyes2Enabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
...
RollGroupbox2:AddToggle(
    "AutoRollEnergyTeiguToggle",
    {
        Text = "Energy Teigu",
        Default = config.AutoRollEnergyTeiguToggle or false,
        Tooltip = "Automatically unlocks and rolls Power Eyes 2.",
        Callback = function(Value)
            autoRollEnergyTeiguEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                    ...
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    while autoRollEnergyTeiguEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
...
RollGroupbox2:AddToggle(
    "AutoRollDamageTeiguToggle",
    {
        Text = "Damage Teigu",
        Default = config.AutoRollDamageTeiguToggle or false,
        Tooltip = "Automatically unlocks and rolls Power Eyes 2.",
        Callback = function(Value)
            autoRollDamageTeiguEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                    ...
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    while autoRollDamageTeiguEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
...
RollGroupbox2:AddToggle(
    "AutoRollPsychoFlowToggle",
    {
        Text = "Psycho Flow",
        Default = config.AutoRollPsychoFlowToggle or false,
        Tooltip = "Automatically unlocks and rolls Power Eyes 2.",
        Callback = function(Value)
            autoRollPsychoFlowEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                    ...
                    task.wait(0.5)
                    local errorCount = 0
                    while autoRollPsychoFlowEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
                        ...
                        local ok, err = pcall(function() ToServer:FireServer(unpack(args)) end)
                        if not ok then
                            errorCount = errorCount + 1
                            warn("[AutoRollPsychoFlow] FireServer error:", err)
                            if errorCount >= 3 then
                                warn("[AutoRollPsychoFlow] Too many errors, disabling to prevent crash.")
                                autoRollPsychoFlowEnabled = false
                                break
                            end
                        else
                            errorCount = 0
...
RollGroupbox2:AddToggle(
    "AutoRollPsychoDestructionToggle",
    {
        Text = "Psycho Destruction",
        Default = config.AutoRollPsychoDestructionToggle or false,
        Tooltip = "Automatically unlocks and rolls Power Eyes 2.",
        Callback = function(Value)
            autoRollPsychoDestructionEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                            ["Upgrading_Name"] = "Unlock";
                            ["Action"] = "_Upgrades";
                            ["Name"] = "Psycho_Destruction"
                        }
                    }
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    local errorCount = 0
                    while autoRollPsychoDestructionEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
                        ...
                        if not ok then
                            errorCount = errorCount + 1
                            warn("[AutoRollPsychoDestruction] FireServer error:", err)
                            if errorCount >= 3 then
                                warn("[AutoRollPsychoDestruction] Too many errors, disabling to prevent crash.")
                                autoRollPsychoDestructionEnabled = false
                                break
                            end
                        else
                            errorCount = 0
...
RollGroupbox2:AddToggle(
    "AutoRollSlayerMarksToggle",
    {
        Text = "Slayer Marks",
        Default = config.AutoRollSlayerMarksToggle or false,
        Tooltip = "Automatically unlocks and rolls Slayer Marks.",
        Callback = function(Value)
            autoRollSlayerMarksEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                    ...
                    task.wait(0.5)
                    local errorCount = 0
                    while autoRollSlayerMarksEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
                        ...
                        if not ok then
                            errorCount = errorCount + 1
                            warn("[AutoRollSlayerMarks] FireServer error:", err)
                            if errorCount >= 3 then
                                warn("[AutoRollSlayerMarks] Too many errors, disabling to prevent crash.")
                                autoRollSlayerMarksEnabled = false
                                break
                            end
                        else
                            errorCount = 0
...
RollGroupbox2:AddToggle(
    "AutoRollDemonBloodlineToggle",
    {
        Text = "Demon Bloodline",
        Default = config.AutoRollDemonBloodlineToggle or false,
        Tooltip = "Automatically unlocks and rolls Demon Bloodline.",
        Callback = function(Value)
            autoRollDemonBloodlineEnabled = Value
            if Value then
                task.spawn(function()
                    local args = {
                        [1] = {
                            ["Upgrading_Name"] = "Unlock";
                            ["Action"] = "_Upgrades";
                            ["Name"] = "Demon_Bloodline"
                        }
                    }
                    pcall(function() ToServer:FireServer(unpack(args)) end)
                    task.wait(0.5)
                    local errorCount = 0
                    while autoRollDemonBloodlineEnabled and getgenv().SeisenHubRunning do
                        local args = {
                            [1] = {
                                ["Open_Amount"] = 10,
                                ["Action"] = "_Gacha_Activate",
                        ...
                        if not ok then
                            errorCount = errorCount + 1
                            warn("[AutoRollDemonBloodline] FireServer error:", err)
                            if errorCount >= 3 then
                                warn("[AutoRollDemonBloodline] Too many errors, disabling to prevent crash.")
                                autoRollDemonBloodlineEnabled = false
                                break
                            end
                        else
                            errorCount = 0
...
local redeemCodes = {
    "Update29P2","Update29P2Code","Update29P2Code2","IsChristmasComing?!","785KFav",
    ...
    "Update25", "740KFav", "745KFav", "240MVisits", "StoneCode","Update26", "755KFav", "Update26Code", "ThanksgivingOnPart2?", "Update26Code2", "Update26Restart1", "Update26P2", "250MVisits", "Update26P2Code", "SorryNoTurkey", "PowerOfFriendship","Update27P2", "765KFav", "770KFav", "Update27P2Code", "255MVisits", "NoThanksgivingCode2", "Update27", "400KLikes", "760KFav", "Update27Code", "NoThanksgivingCode","Update27","400KLikes","760KFav","Update27Code","NoThanksgivingCode","Update27Delay","Update27Restart","SorryNoTurkey2","SorryNoTurkey3","SorryNoTurkey4",
    "Update24P2", "720KFav", "725KFav", "230MVisits", "Update24Part2Code", "Update24P3", "730KFav", "735KFav", "390KLikes", "235MVisits","33KPlayers", "150KLikes", "DungeonFall1", "Update13", "155KLikes", "350KFav", "360KFav", "40MVisits", "Shutdown123", "34KOnline", "35KCCU", "?43KRecord?", "?44KRecord?", "?Record45K?!", "?Record46K?!", "?NewRecord47k", "?SupaRecord48k", "?Supa49kRecord", "?Ultra50KRecord", "?Update14P2", "175KLikes", "180KLikes", "400KFav", "405KFav", "?Update14P3", "185KLikes", "190KLikes", "410KFav", "415KFav", "?51kPlayers", "?52kPlayers", "?53kPlayers", "Update15", "195KLikes", "200KLikes", "420KFav", "425KFav", "Update15Delay", "BugsUpdate15", "2BugsUpdate15", "51kPlayers", "52kPlayers", "53kPlayers", "Ultra50KRecord", "Supa49kRecord", "SupaRecord48k", "NewRecord47k", "Record45K?!", "?Record46K?!", "44KRecord??", "Update14P2", "175KLikes", "180KLikes", "400KFav", "405KFav", "?42K?","Update23", "680KFav", "685KFav", "375KLikes", "215MVisits", "Update23Restart",
    "Update24", "710KFav", "715KFav", "CodeGeass", "385KLikes","Update23P3", "700KFav", "705KFav", "225MVisits", "Update23P3Code", "Update23P2", "690KFav", "695KFav", "380KLikes", "Update23Code","CodeGeass2","SomeQuickFix1a", "SomeQuickFix2", "?41KRecord?", "40KRecord?", "39KRecordCcu", "Update14", "170KLikes", "50MVisits", "395KFav", "390KFav", "DungeonQuickFix", "Update13P3", "165KLikes", "375KFav", "380KFav", "385KFav", "1GhoulKeyNoMore", "IWantKey", "Online36K", "37KPlayersOn", "38KRecord", "Update13P2", "365KFav", "370KFav", "50K", "160KLikes", "Shutdown123", "Update13", "155KLikes", "350KFav", "360KFav", "40MVisits", "DungeonFall1", "Update12.5", "31KPlayers", "32KPlayers", "33KPlayers", "150KLikes", "Update12.2", "35MVisits", "140KLikes", "340KFav", "29KPlayers", "30kOnline", "Update12.2Late", "PotionFix1", "25KPlayers", "26KPlayers", "27KPlayers", "28KPlayers", "BugFixSome", "Update12", "Update15P2", "205KLikes", "210KLikes", "430KFav",
}
