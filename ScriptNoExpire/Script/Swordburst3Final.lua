game.StarterGui:SetCore("SendNotification", {
    Title = "Seisen Hub";
    Text = "Swordburst 3 Script Loaded";
    Duration = 10; -- seconds
})
game.StarterGui:SetCore("SendNotification", {
    Title = "Stay Updated!";
...
Library.ShowCustomCursor = true -- Enable custom cursor by default
...
local dungeonDifficulties = {"Easy", "Medium", "Hard", "Insane", "Extreme", "Nightmare","Oblivion"}
...
local ScriptControlBox = MainTab:AddLeftGroupbox("Script Control")
