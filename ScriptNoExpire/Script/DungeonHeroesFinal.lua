game.StarterGui:SetCore("SendNotification", {
    Title = "Seisen Hub";
    Text = "Dungeon Heroes Script Loaded";
    Duration = 10; -- seconds
})
game.StarterGui:SetCore("SendNotification", {
    Title = "Stay Updated!";
        ...
        if autoEquipHighestWeapon then
            ...
            if profile and profile.Inventory and profile.Equipped then
                ...
                local function findBestInInventory(category, typeName, equippedItem)
                    local magicKeywords = {"magic", "wand", "staff", "spell", "orb", "tome","scepter", "stave"}
...
local raidDungeonNameMap = {
    ...
    ["Rumbling Plateau"] = "RumblingPlateauRaid"
}
local eventDungeonNameMap = {
    ["The Gauntlet"] = "Gauntlet",
    ["Fire Cult"] = "FireCultDungeon",
...
RaidDungeonBox:AddDropdown("RaidDungeonName", {
    Text = "Dungeon Name",
    Values = {"Abyssal Depths", "Sky Citadel", "Molten Volcano", "Rumbling Plateau"},
...
EventDungeonBox:AddDropdown("EventDungeonName", {
    Text = "Dungeon Name",
    Values = {"Gauntlet", "Fire Cult", "Christmas Dungeon"},
...
-- Auto Hide UI Toggle
UICustomGroup:AddToggle("AutoHideUIToggle", {
    Text = "Auto Hide UI",
...
InfoGroup:AddLabel("Version: 3.0.0")
