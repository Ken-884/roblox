...
local DungeonGroupbox = TeleportTab:AddRightGroupbox("Auto Dungeon", "badge")
...
DungeonGroupbox:AddButton(
    ...
    "Teleport into the Ghoul Raid dungeon."
)



DungeonGroupbox:AddButton(
    "Enter Progression Raid",
    function()
        local args = {
            [1] = {
                ["Action"] = "_Enter_Dungeon",
    ...
    "Teleport into the Progression Raid dungeon."
)
...
DungeonGroupbox:AddButton(
    ...
    "Teleport into the Gleam Raid dungeon."
)

DungeonGroupbox:AddButton(
    "Enter Tournament Raid",
    function()
        local args = {
            [1] = {
                ["Action"] = "_Enter_Dungeon",
    ...
    "Teleport into the Tournament Raid dungeon."
)
...
DungeonGroupbox:AddButton(
    ...
    "Teleport into the Chainsaw Defense dungeon."
)
...
DungeonGroupbox:AddButton(
    ...
    "Teleport into the Titan Defense dungeon."
)
...
DungeonGroupbox:AddButton(
    ...
    "Teleport into the Kaiju Dungeon."
)
...
UISettingsGroup:AddButton("Unload Script", function()
    ...
    -- Set all automation variables to false
